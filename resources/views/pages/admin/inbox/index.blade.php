                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($data as $item)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href=" {{ asset('storage/inbox/' . $item->file_surat) }} "
                                                                class="btn btn-primary"><i
                                                                    class='fas fa-info-circle'></i></a>
                                                            <button type="button" class="btn btn-danger" data-toggle="modal"
                                                                data-target="#deleteModal"
                                                                data-inbox="{{ $item->id }}"><i
                                                                    class='fas fa-trash'></i></button>
                                                            <a href="{{route('inbox.edit',$item->id)}}" class="btn btn-warning"><i
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="inbox"
                                                        placeholder="Isi surat Masuk" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="inputName" class="col-sm-2 col-form-label">Nomor Surat Masuk</label>
                                                <div class="col-sm-10">
                                                    <input type="text" class="form-control" name="no_inbox"
                                                        placeholder="Isi Nomor Surat Masuk" value="" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="input-group col-sm-10">
                                                    <div class="custom-file">
                                                        <input type="file" class="custom-file-input" value=""
                                                            name="file_inbox" placeholder="file surat masuk" required accept=".pdf">
