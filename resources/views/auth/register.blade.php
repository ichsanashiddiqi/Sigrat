...
<div class="login-form">
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="text-center">
            <a href="index.html" aria-label="Space">
                <img class="mb-3" src="assets/images/Logo_balittas.png" alt="Logo" width="60" height="60">
            </a>
          </div>
        ...
        <div class="js-form-message mb-3">
            <div class="js-focus-state input-group form">
              ...
              <input id="nama" type="text" class="form-control form__input @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama') }}"placeholder="Nama" autocomplete="nama" autofocus>
                @error('nama')
        ...
        <div class="js-form-message mb-3">
            <div class="js-focus-state input-group form">
              <div class="input-group-prepend form__prepend">
                <span class="input-group-text form__text">
                  <i class="fa fa-vcard form__text-inner"></i>
                </span>
              </div>
              <input id="nip" type="text" class="form-control form__input @error('nip') is-invalid @enderror" name="nip" value="{{ old('nip') }}"placeholder="NIP" autocomplete="nip" autofocus>
                @error('nip')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
	...
	<div class="form-group">
        ...
        <p class="small text-center text-muted mb-0">All rights reserved. © Sigrat</p>
    </form>
</div>